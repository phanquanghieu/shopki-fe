        ...
        <div className='profile-content'>
          ...
          <div className='profile-detail'>
            ...
            <div className='profile-label-input'>
              <label htmlFor='' className='profile-label'>Tên</label>
            ...
            <div className={`profile-label-email ${isChangeEmail}`}>
              ...
              {isChangeEmail ? <div>
                ...
                <span href='' className='profile-change' onClick={() => handleSaveEmail()}>Lưu</span>
              </div> : <div>
                <p className='profile-input'>th**********@gmail.com</p>
                <span href='' className='profile-change' onClick={() => handleChangeEmail()}>Thay đổi</span>
              </div>}
            </div>

            {/* SĐT */}
            <div className='profile-label-email'>
              <label htmlFor='' className='profile-label'>Số Điện Thoại</label>
              <p className='profile-input'>********98</p>
              <a href='' className='profile-change'>Thay đổi</a>
            ...
            {/* Tên shop */}
            <div className='profile-label-input'>
              <label htmlFor='' className='profile-label'>Tên shop</label>
            ...
            <div className='profile-label-input'>
              ...
              <form className='profile-gender'>
                <input className='gender' name='gioitinh' type='radio' value='Nam' />Nam
                <input className='gender' name='gioitinh' type='radio' value='Nữ' />Nữ
                <input className='gender' name='gioitinh' type='radio' value='Khác' />Khác
              </form>
            </div>

            {/* ngày sinh */}
            <div className='profile-birthday'>
              <label htmlFor='' className='profile-label'>Ngày sinh</label>
